...
parsed_df = df.selectExpr("CAST(value AS STRING)") \
    ...
    .withColumn("is_positive", (col("predicted_label") >= 0.5).cast("integer"))
...
def process_with_dgim(batch_df, batch_id):
    try:
        ...
        dgim_state_collection = db["dgim_state"]
        dgim_stats_collection = db["dgim_stats"]
        raw_data_collection = db["raw_data_sample"]
